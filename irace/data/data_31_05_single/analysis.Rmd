...
instance_file = "./irace/data/data_31_05_single/irace_instance.rda"
log_file = "./irace/data/data_31_05_single/irace_log.Rdata"
...
tab = data.table(
  ...
  benchmark = "LCBench & rbv2_super",
  instances = "8 (LCBench) + 30 (rbv2_super)",
  target = "val_cross_entropy (lcbench) & logloss (rbv2_super)"
)
kable(tab)
```
...
| surrogate_learner                | ParamFct |            |            | ranger, knn              |
